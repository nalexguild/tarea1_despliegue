...
<div class="row">
    ...
    <button id="nuevo" class="btn btn-success form-control">Nuevo</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <span id="mostrar_si_existe">El nombre de usuario debe tener entre <strong>4 y 12</strong> carácteres</span>
                </div>
                <div class="form-group">
                    ...
                    <span>La contraseña debe tener entre <strong>8 y 12</strong> carácteres, entre ellos debe haber al menos un dígito, una letra mayúscula y una letra minúscula.</span>
                </div>
                <div class="form-group">
